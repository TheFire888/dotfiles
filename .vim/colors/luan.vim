...
hi Function         cterm=NONE              ctermfg=darkred         ctermbg=NONE
...
hi Exception        cterm=NONE              ctermfg=brown           ctermbg=NONE

hi PreProc          cterm=NONE              ctermfg=darkblue        ctermbg=NONE
hi Include          cterm=NONE              ctermfg=darkblue        ctermbg=NONE
hi Define           cterm=NONE              ctermfg=darkblue        ctermbg=NONE
hi Macro            cterm=NONE              ctermfg=darkblue        ctermbg=NONE
hi PreCondit        cterm=NONE              ctermfg=darkblue        ctermbg=NONE

hi Type             cterm=NONE              ctermfg=yellow          ctermbg=NONE
hi StorageClass     cterm=NONE              ctermfg=yellow          ctermbg=NONE
hi Structure        cterm=NONE              ctermfg=yellow          ctermbg=NONE
hi Typedef          cterm=NONE              ctermfg=yellow          ctermbg=NONE
...
hi Delimiter        cterm=NONE              ctermfg=darkblue        ctermbg=NONE
...
hi Todo             cterm=NONE              ctermfg=black            ctermbg=darkblue
...
hi MatchParen       cterm=NONE              ctermfg=black           ctermbg=darkcyan
...
hi Title            cterm=NONE              ctermfg=brown           ctermbg=NONE
...
hi DiffChange       cterm=NONE              ctermfg=NONE            ctermbg=brown
...
" SEARCH
""""""""""""""""""""""""
hi IncSearch        cterm=NONE              ctermfg=black           ctermbg=darkcyan
